    ...
    <div className={`social-media-post ${isExpanded ? 'expanded' : ''}`}>
      ...
      <div className={`card ${isExpanded ? 'expanded' : ''}`} style={{ border: 'none',paddingTop: '50px' }}>
        ...
        <div className={`img-job-vide ${isExpanded ? 'expanded' : ''}`}>
          ...
          <img src={gallery} alt="" srcset=""/><p className="d-none d-lg-block">Image</p>
            <input
              type='file'
              accept='image/*'
              style={{ display: 'none' }}
          ...
          <button style={{ backgroundColor: 'white', color: 'black', padding: '5px 10px', marginLeft: '0px', display: 'flex', alignItems: 'center', gap: '5px', fontSize: '15px', width: '18%', borderRadius: '3em',border: '1px solid #a98de3'  }} onClick={() => setShowPollModal(true)}><img src={poll} alt="" srcset="" /><p className="d-none d-lg-block">Poll</p></button>
          ...
          <img src={video} alt="" srcset="" /><p className="d-none d-lg-block">Video</p>
            <input
              type='file'
              accept='video/*'
              style={{ display: 'none' }}
